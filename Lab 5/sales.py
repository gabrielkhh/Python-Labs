...
print("The scaled number is: %a The sorted sales numbers are: %a The good sales numbers are: %a" % (
    scale(sales_list, scale_factor), sorted(sales_list), goodSales(sales_list)))
